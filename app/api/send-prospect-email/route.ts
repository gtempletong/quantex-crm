 ...
 * Envía email con formato HTML y attachments a un prospecto desde el dashboard
 */
  ...
  try {
    ...
    if (!prospectId || !to || !subject || !body) {
      return NextResponse.json(
        { error: 'prospectId, to, subject y body son requeridos' },
        { status: 400 }
      );
    }

    console.log(`📧 Enviando email a prospecto: ${to} (ID: ${prospectId})`);
    ...
    // 2. Buscar company_id del prospecto
